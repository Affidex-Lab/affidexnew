      ...
      <section className="py-24" style={{background:"#FFFFFF",borderBottom:"1px solid var(--border)"}}>
        <div className="container">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4 max-w-[1000px]">
            {[
              {initials:"UES",name:"Utibe-Abasi Emmanuel Samuel",role:"Chairman & CEO",bio:"Founder and Chief Executive. Technology entrepreneur and vocational education advocate based in Uyo. Drove the institution from incorporation to internationally affiliated standing in under 90 days."},
              ...
              <div key={i} className="card rounded-2xl border p-6" style={{borderColor:"var(--border)"}}>
                <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl text-white text-sm font-black"
